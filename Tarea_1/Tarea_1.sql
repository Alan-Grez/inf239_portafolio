...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ALUMNO" 
   (	"RUT_ALUMNO___ALUMNO" VARCHAR2(10 BYTE), 
	"NOMBRE___ALUMNO" VARCHAR2(15 BYTE), 
	"PODER___ALUMNO" VARCHAR2(15 BYTE), 
	"LICENCIA___ALUMNO" NUMBER(1,0), 
	"INGRESO___ALUMNO" NUMBER(4,0)
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."ASIGNATURA" 
   (	"ID_ASIGNATURA___ASIGNATURA" NUMBER(6,0), 
	"NOMBRE___ASIGNATURA" VARCHAR2(20 BYTE), 
	"DESCRIPCION___ASIGNATURA" VARCHAR2(256 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CURSO" 
   (	"ID_CURSO___CURSO" NUMBER(6,0), 
	"SEMESTRE___CURSO" NUMBER(1,0), 
	"ANIO___CURSO" NUMBER(4,0), 
	"RUT_PROFESOR___CURSO" VARCHAR2(10 BYTE), 
	"ID_ASIGNATURA___CURSO" NUMBER(6,0), 
	"ID_SALA___CURSO" NUMBER(6,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."FUNCIONARIO" 
   (	"RUT_FUNCIONARIO___FUNCIONARIO" VARCHAR2(10 BYTE), 
	"NOMBRE___FUNCIONARIO" VARCHAR2(15 BYTE), 
	"PODER___FUNCIONARIO" VARCHAR2(15 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."INSCRIPCION" 
   (	"ID_INSCRIPCION___INSCRIPCION" NUMBER(6,0), 
	"NOTA___INSCRIPCION" NUMBER(3,0), 
	"RUT_ALUMNO___INSCRIPCION" VARCHAR2(10 BYTE), 
	"ID_CURSO___INSCRIPCION" NUMBER(6,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MANTENIMIENTO" 
   (	"RUT_FUNCIONARIO___MANTENIMIENTO" VARCHAR2(10 BYTE), 
	"ID_SALA___MANTENIMIENTO" NUMBER(6,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PROFESOR" 
   (	"RUT_PROFESOR___PROFESOR" VARCHAR2(10 BYTE), 
	"NOMBRE___PROFESOR" VARCHAR2(15 BYTE), 
	"PODER___PROFESOR" VARCHAR2(15 BYTE), 
	"AGENCIA___PROFESOR" VARCHAR2(15 BYTE), 
	"TIPO___PROFESOR" NUMBER(1,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SALA" 
   (	"ID_SALA___SALA" NUMBER(6,0), 
	"CAPACIDAD___SALA" NUMBER(3,0), 
	"DISPONIBILIDAD___SALA" NUMBER(1,0), 
	"TIPO___SALA" VARCHAR2(15 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
--  DDL for View VISTA_PODERES
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_PODERES" ("PODER", "TOTAL") AS 
  Select Poder,Count(Poder) As Total From Vista_Poderes_Aux Group By Poder
;
--------------------------------------------------------
--  DDL for View VISTA_PODERES_AUX
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_PODERES_AUX" ("RUT", "PODER") AS 
  Select Rut_Profesor___Profesor As Rut  ,Poder___Profesor As Poder From Profesor
    Union
...
;
--------------------------------------------------------
--  DDL for View VISTA_PROFESORES
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_PROFESORES" ("NOMBRE___PROFESOR", "N_CURSO") AS 
  Select P.Nombre___Profesor, Count(C.Id_Curso___Curso) As N_Curso 
    From Profesor P
    Join Curso C On C.Rut_Profesor___Curso = P.Rut_Profesor___Profesor
    Group By P.Nombre___Profesor
    Having Count(C.Id_Curso___Curso)>7
;
--------------------------------------------------------
--  DDL for View VISTA_SALAS
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_SALAS" ("SALA", "FUNCIONARIO", "FECHA") AS 
...
;
--------------------------------------------------------
--  DDL for View VISTA_SIDEKICK
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_SIDEKICK" ("PROFESOR", "ALUMNO", "NOTA") AS 
  Select Profesor.Nombre___Profesor As Profesor, Alumno.Nombre___Alumno As Alumno,Inscripcion.Nota___Inscripcion As Nota
        ...
        order by Profesor, Nota Desc, Alumno
;
--------------------------------------------------------
--  DDL for View VISTA_SUPER
--------------------------------------------------------

  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "SYSTEM"."VISTA_SUPER" ("RUT", "PODER") AS 
  Select RUT, Poder From Vista_Poderes_Aux
    Where Poder Like '%Super%'
;
REM INSERTING into SYSTEM.ALUMNO
SET DEFINE OFF;
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('199948458','Alan','Super Flojear','1','2017');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('199903891','Maxi','Enojarse','1','2017');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('191231881','Mario','Super Seriedad','1','2017');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('191892379','Benito','Parlanchin','1','2016');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('163492132','Hugo','Super Pesado','0','2016');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('134717203','Sebastian','Bolacion','1','2016');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('134737830','Cristobal','Bolacion','1','2014');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('127837430','Hector','Armazon','1','2014');
Insert into SYSTEM.ALUMNO (RUT_ALUMNO___ALUMNO,NOMBRE___ALUMNO,PODER___ALUMNO,LICENCIA___ALUMNO,INGRESO___ALUMNO) values ('876737830','Hahns','Super Tareas','0','2014');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ASIGNATURA
SET DEFINE OFF;
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('1','MATE 1','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('2','MATE 2','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('3','MATE 3','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('4','MATE 4','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('5','Progra','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('6','Mec Flui','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('7','Termo','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('8','Datos','mucho texto');
Insert into SYSTEM.ASIGNATURA (ID_ASIGNATURA___ASIGNATURA,NOMBRE___ASIGNATURA,DESCRIPCION___ASIGNATURA) values ('9','Estruc','mucho texto');
REM INSERTING into SYSTEM.CURSO
SET DEFINE OFF;
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('1','1','2020','199948421','1','1');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('2','1','2020','573981722','2','2');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('3','2','2019','100023434','1','3');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('4','2','2017','328318328','3','4');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('5','2','2017','328318328','3','4');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('6','1','2016','373234734','5','5');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('7','2','2015','373234734','5','6');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('8','1','2014','289239819','3','4');
Insert into SYSTEM.CURSO (ID_CURSO___CURSO,SEMESTRE___CURSO,ANIO___CURSO,RUT_PROFESOR___CURSO,ID_ASIGNATURA___CURSO,ID_SALA___CURSO) values ('9','2','2014','072837829','9','1');
REM INSERTING into SYSTEM.FUNCIONARIO
SET DEFINE OFF;
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('8123490888','Darcy','Dios');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('6318276781','Rodrigo','Super Aseo');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('8971388211','Marcela','Super Data');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('2371238719','Jocelyn','Marimbas');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('8431234728','Michael','Super Manitas');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('6462829120','Doruk','Super Orden');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('3746501083','Javier','Diablo');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('7312897646','Nicole','Fisca cuantica');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('0091287371','Nissan','Arreglar');
Insert into SYSTEM.FUNCIONARIO (RUT_FUNCIONARIO___FUNCIONARIO,NOMBRE___FUNCIONARIO,PODER___FUNCIONARIO) values ('3127829010','Joane','Super Fix');
...
REM INSERTING into SYSTEM.INSCRIPCION
SET DEFINE OFF;
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('1','88','199948458','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('2','78','199948458','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('3','56','199948458','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('4','66','199948458','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('5','100','199948458','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('6','98','199948458','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('7','77','199948458','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('8','59','199948458','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('9','90','199948458','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('10','90','199903891','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('11','67','199903891','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('12','100','199903891','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('13','89','199903891','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('14','76','199903891','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('15','56','199903891','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('16','89','199903891','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('17','91','199903891','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('18','55','199903891','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('19','55','191231881','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('20','23','191231881','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('21','89','191231881','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('22','73','191231881','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('23','54','191231881','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('24','19','191231881','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('25','100','191231881','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('26','78','191231881','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('27','93','191231881','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('28','93','191892379','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('29','93','191892379','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('30','12','191892379','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('31','45','191892379','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('32','54','191892379','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('33','23','191892379','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('34','65','191892379','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('35','55','191892379','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('36','91','191892379','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('37','91','163492132','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('38','91','163492132','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('39','91','163492132','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('40','91','163492132','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('41','91','163492132','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('42','91','163492132','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('43','91','163492132','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('44','91','163492132','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('45','91','163492132','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('46','91','134717203','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('47','81','134717203','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('48','17','134717203','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('49','4','134717203','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('50','89','134717203','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('51','34','134717203','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('52','54','134717203','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('53','87','134717203','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('54','21','134717203','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('55','21','134737830','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('56','23','134737830','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('57','56','134737830','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('58','36','134737830','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('59','87','134737830','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('60','84','134737830','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('61','44','134737830','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('62','87','134737830','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('63','66','134737830','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('64','66','127837430','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('65','12','127837430','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('66','100','127837430','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('67','83','127837430','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('68','56','127837430','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('69','67','127837430','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('70','42','127837430','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('71','79','127837430','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('72','99','127837430','9');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('73','92','876737830','1');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('74','74','876737830','2');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('75','82','876737830','3');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('76','12','876737830','4');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('77','45','876737830','5');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('78','67','876737830','6');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('79','54','876737830','7');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('80','23','876737830','8');
Insert into SYSTEM.INSCRIPCION (ID_INSCRIPCION___INSCRIPCION,NOTA___INSCRIPCION,RUT_ALUMNO___INSCRIPCION,ID_CURSO___INSCRIPCION) values ('81','1','876737830','9');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MANTENIMIENTO
SET DEFINE OFF;
Insert into SYSTEM.MANTENIMIENTO (RUT_FUNCIONARIO___MANTENIMIENTO,ID_SALA___MANTENIMIENTO,FECHA___MANTENIMIENTO) values ('3127829010','4',to_date('13/06/20','DD/MM/RR'));
Insert into SYSTEM.MANTENIMIENTO (RUT_FUNCIONARIO___MANTENIMIENTO,ID_SALA___MANTENIMIENTO,FECHA___MANTENIMIENTO) values ('6318276781','2',to_date('11/06/20','DD/MM/RR'));
Insert into SYSTEM.MANTENIMIENTO (RUT_FUNCIONARIO___MANTENIMIENTO,ID_SALA___MANTENIMIENTO,FECHA___MANTENIMIENTO) values ('6462829120','3',to_date('12/06/20','DD/MM/RR'));
Insert into SYSTEM.MANTENIMIENTO (RUT_FUNCIONARIO___MANTENIMIENTO,ID_SALA___MANTENIMIENTO,FECHA___MANTENIMIENTO) values ('8123490888','1',to_date('10/06/20','DD/MM/RR'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PROFESOR
SET DEFINE OFF;
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('199948421','Cerpa','Volar','DMAT','1');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('289239819','Marti','Super Programar','INF','2');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('328318328','Isabel','Dinamicas','DMAT','3');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('412839128','Victor','Super Algebrita','DMAT','2');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('573981722','Galvez','Super Risas','INF','1');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('373234734','Arroyuelo','Precision','INF','2');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('775671234','Gomez','Super Drogas','IQA','3');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('100023434','Ardila','Stokes','MEC','3');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('112323987','Berlin','Super Corriente','ELI','1');
Insert into SYSTEM.PROFESOR (RUT_PROFESOR___PROFESOR,NOMBRE___PROFESOR,PODER___PROFESOR,AGENCIA___PROFESOR,TIPO___PROFESOR) values ('072837829','Urbina','Hiper Turbina','ACA','3');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SALA
SET DEFINE OFF;
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('1','60','1','Teatro');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('2','60','1','Teatro');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('3','160','1','Circular');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('4','160','1','Circular');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('5','60','1','B-12');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('6','60','1','B-13');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('7','60','1','B-14');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('8','60','0','B-15');
Insert into SYSTEM.SALA (ID_SALA___SALA,CAPACIDAD___SALA,DISPONIBILIDAD___SALA,TIPO___SALA) values ('9','60','0','C-01');
...
REM INSERTING into SYSTEM.VISTA_PODERES
SET DEFINE OFF;
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Arreglar','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Marimbas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Programar','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Fix','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Manitas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Tareas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Hiper Turbina','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Pesado','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Volar','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Flojear','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Diablo','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Bolacion','2');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Risas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Dinamicas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Dios','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Parlanchin','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Enojarse','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Algebrita','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Aseo','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Stokes','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Corriente','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Armazon','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Precision','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Fisca cuantica','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Drogas','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Seriedad','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Orden','1');
Insert into SYSTEM.VISTA_PODERES (PODER,TOTAL) values ('Super Data','1');
REM INSERTING into SYSTEM.VISTA_PODERES_AUX
SET DEFINE OFF;
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('0091287371','Arreglar');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('072837829','Hiper Turbina');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('100023434','Stokes');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('112323987','Super Corriente');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('127837430','Armazon');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('134717203','Bolacion');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('134737830','Bolacion');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('163492132','Super Pesado');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('191231881','Super Seriedad');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('191892379','Parlanchin');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('199903891','Enojarse');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('199948421','Volar');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('199948458','Super Flojear');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('2371238719','Marimbas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('289239819','Super Programar');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('3127829010','Super Fix');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('328318328','Dinamicas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('373234734','Precision');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('3746501083','Diablo');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('412839128','Super Algebrita');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('573981722','Super Risas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('6318276781','Super Aseo');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('6462829120','Super Orden');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('7312897646','Fisca cuantica');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('775671234','Super Drogas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('8123490888','Dios');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('8431234728','Super Manitas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('876737830','Super Tareas');
Insert into SYSTEM.VISTA_PODERES_AUX (RUT,PODER) values ('8971388211','Super Data');
REM INSERTING into SYSTEM.VISTA_PROFESORES
SET DEFINE OFF;
REM INSERTING into SYSTEM.VISTA_SALAS
SET DEFINE OFF;
Insert into SYSTEM.VISTA_SALAS (SALA,FUNCIONARIO,FECHA) values ('1','Darcy',to_date('10/06/20','DD/MM/RR'));
Insert into SYSTEM.VISTA_SALAS (SALA,FUNCIONARIO,FECHA) values ('2','Rodrigo',to_date('11/06/20','DD/MM/RR'));
Insert into SYSTEM.VISTA_SALAS (SALA,FUNCIONARIO,FECHA) values ('3','Doruk',to_date('12/06/20','DD/MM/RR'));
Insert into SYSTEM.VISTA_SALAS (SALA,FUNCIONARIO,FECHA) values ('4','Joane',to_date('13/06/20','DD/MM/RR'));
REM INSERTING into SYSTEM.VISTA_SIDEKICK
SET DEFINE OFF;
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Mario','100');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Alan','98');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Maxi','89');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Cristobal','84');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Alan','77');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Hector','67');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Benito','65');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Arroyuelo','Maxi','56');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Maxi','91');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Cristobal','87');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Sebastian','87');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Hector','79');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Mario','78');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Alan','59');
Insert into SYSTEM.VISTA_SIDEKICK (PROFESOR,ALUMNO,NOTA) values ('Marti','Benito','55');
REM INSERTING into SYSTEM.VISTA_SUPER
SET DEFINE OFF;
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('112323987','Super Corriente');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('163492132','Super Pesado');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('191231881','Super Seriedad');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('199948458','Super Flojear');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('289239819','Super Programar');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('3127829010','Super Fix');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('412839128','Super Algebrita');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('573981722','Super Risas');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('6318276781','Super Aseo');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('6462829120','Super Orden');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('775671234','Super Drogas');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('8431234728','Super Manitas');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('876737830','Super Tareas');
Insert into SYSTEM.VISTA_SUPER (RUT,PODER) values ('8971388211','Super Data');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index SYS_C009493
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009493" ON "SYSTEM"."PROFESOR" ("RUT_PROFESOR___PROFESOR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009496
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009496" ON "SYSTEM"."ASIGNATURA" ("ID_ASIGNATURA___ASIGNATURA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009501
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009501" ON "SYSTEM"."ALUMNO" ("RUT_ALUMNO___ALUMNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009502
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009502" ON "SYSTEM"."SALA" ("ID_SALA___SALA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009503" ON "SYSTEM"."FUNCIONARIO" ("RUT_FUNCIONARIO___FUNCIONARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009504
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009504" ON "SYSTEM"."MANTENIMIENTO" ("RUT_FUNCIONARIO___MANTENIMIENTO", "ID_SALA___MANTENIMIENTO", "FECHA___MANTENIMIENTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009507
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009507" ON "SYSTEM"."CURSO" ("ID_CURSO___CURSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SYS_C009512
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C009512" ON "SYSTEM"."INSCRIPCION" ("ID_INSCRIPCION___INSCRIPCION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Trigger TRIGGER_ELIMINAR
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRIGGER_ELIMINAR" Before Delete On Asignatura For Each Row 
    Begin
        Delete From Inscripciones Where Id_Curso_Inscripcion = (Select Id_Curso___Curso From Curso Where Id_Asignatura___Curso =: Old.Id_Asignatura___Asignatura);
        Delete From Curso Where Id_Asignatura___Curso =: Old.Id_Asignatura___Asignatura;
    End;


-- Creamos funciones auxiliares para establecer el semestre actual y crear un nuevo id_curso
Drop Function Det_Semestre;
Create Function Det_Semestre
    Return Number Is
        Semestre Number(1);
    Begin
        If Extract(Month From Sysdate) < 6 Then Semestre:=1;
        Else Semestre:=2;
        End If;
        Return Semestre;
    End;

Drop Function Create_Id_Curso;
Create Function Create_Id_Curso(Asig Varchar2)
    Return Varchar Is
        Id_Curso Varchar2(6);
    Begin
        Select 	Id_Curso___Curso  Into Id_Curso From Curso
        Where Rownum <=1 Order By Id_Curso___Curso Desc ;
        Return Id_Curso +1;
    End;

Drop Trigger Trigger_Profesor;
Create Trigger Trigger_Profesor After Insert On Profesor For Each Row 
    Begin
    Insert Into Curso Select 
        Create_Id_Curso(Asig.Id_Asignatura___Asignatura),Det_Semestre(),Extract(Year From Sysdate),Rut_Profesor___Profesor,Asig.Id_Asignatura___Asignatura,S.Id_Sala___Sala  
        Into X_1, X_2, X_3, X_4, X_5, X_6
        From Profesor P
        Join Sala S            On S.Disponibilidad___Sala = 1
        Join Asignatura Asig   On Asig.Id_Asignatura___Asignatura Is Not Null
        Join Inscripcion I     On I.Id_Curso___Inscripcion Is Null;
        Insert Into Inscripcion (Id_Curso___Inscripcion) Select Id_Curso___Curso  Into X_7 
        From Curso Sample(75)  -- Los alumnos tienen un 80% de probabilidades de ser inscrito con ese profe, de esta forma se evita que no sean todos
        Join Alumno On Alumno.Licencia___Alumno = 1
        Order By Id_Curso___Curso Desc ;
    End Trigger_Profesor;

/
ALTER TRIGGER "SYSTEM"."TRIGGER_ELIMINAR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRIGGER_ELIMINAR
--------------------------------------------------------
...
ALTER TRIGGER "SYSTEM"."TRIGGER_ELIMINAR" ENABLE;
--------------------------------------------------------
--  DDL for Procedure PROCEDURE_MANTENIMIENTO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROCEDURE_MANTENIMIENTO" (Id_Sala In Number) As
    Aa_Funcionario Varchar2(10):='';
    Begin
        Select 	Rut_Funcionario___Mantenimiento  Into Aa_Funcionario From Mantenimiento
        Where Rownum <=1 Order By Fecha___Mantenimiento Asc ;
        Insert Into Mantenimiento Values (Aa_Funcionario,Id_Sala, Sysdate);
    End;

/
--------------------------------------------------------
--  DDL for Procedure PROCEDURE_REPROBADOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PROCEDURE_REPROBADOS" (Rut_Profesor In Varchar2) As
    Aux1 Varchar2(100):='';
    Aux2 Varchar2(100):='';
    Aux3 Varchar2(100):='';
    Begin
        ...
        Select Alumno.Nombre___Alumno,avg(Inscripcion.Nota___Inscripcion),Asignatura.Nombre___Asignatura Into Aux1,Aux2,Aux3 From Alumno 
        Join Inscripcion On Alumno.Rut_Alumno___Alumno            = Inscripcion.Rut_Alumno___Inscripcion
        Join Curso       On Curso.Id_Curso___Curso                = Inscripcion.Id_Curso___Inscripcion
        Join Asignatura  On Asignatura.Id_Asignatura___Asignatura = Curso.Id_Asignatura___Curso
        Where (Curso.Rut_Profesor___Curso = '373234734' And  Inscripcion.Nota___Inscripcion  < 55)
        group by Alumno.Nombre___Alumno, Asignatura.Nombre___Asignatura;
    End;

/
--------------------------------------------------------
--  DDL for Function CREATE_ID_CURSO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."CREATE_ID_CURSO" (Asig Varchar2)
    Return Varchar Is
        Id_Curso Varchar2(6);
    Begin
        Select 	Id_Curso___Curso  Into Id_Curso From Curso
...
/
--------------------------------------------------------
--  DDL for Function DET_SEMESTRE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."DET_SEMESTRE" 
    Return Number Is
        Semestre Number(1);
    Begin
        If Extract(Month From Sysdate) < 6 Then Semestre:=1;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ALUMNO" MODIFY ("NOMBRE___ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ALUMNO" MODIFY ("PODER___ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ALUMNO" MODIFY ("LICENCIA___ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ALUMNO" MODIFY ("INGRESO___ALUMNO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ALUMNO" ADD PRIMARY KEY ("RUT_ALUMNO___ALUMNO")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ASIGNATURA" MODIFY ("NOMBRE___ASIGNATURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ASIGNATURA" MODIFY ("DESCRIPCION___ASIGNATURA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ASIGNATURA" ADD PRIMARY KEY ("ID_ASIGNATURA___ASIGNATURA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CURSO" MODIFY ("SEMESTRE___CURSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO" MODIFY ("ANIO___CURSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CURSO" ADD PRIMARY KEY ("ID_CURSO___CURSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FUNCIONARIO" ADD PRIMARY KEY ("RUT_FUNCIONARIO___FUNCIONARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."INSCRIPCION" MODIFY ("NOTA___INSCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INSCRIPCION" ADD PRIMARY KEY ("ID_INSCRIPCION___INSCRIPCION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MANTENIMIENTO" ADD PRIMARY KEY ("RUT_FUNCIONARIO___MANTENIMIENTO", "ID_SALA___MANTENIMIENTO", "FECHA___MANTENIMIENTO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PROFESOR" MODIFY ("NOMBRE___PROFESOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESOR" MODIFY ("PODER___PROFESOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESOR" MODIFY ("TIPO___PROFESOR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PROFESOR" ADD PRIMARY KEY ("RUT_PROFESOR___PROFESOR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SALA" ADD PRIMARY KEY ("ID_SALA___SALA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CURSO" ADD FOREIGN KEY ("RUT_PROFESOR___CURSO")
	  REFERENCES "SYSTEM"."PROFESOR" ("RUT_PROFESOR___PROFESOR") ENABLE;
  ALTER TABLE "SYSTEM"."CURSO" ADD FOREIGN KEY ("ID_ASIGNATURA___CURSO")
	  REFERENCES "SYSTEM"."ASIGNATURA" ("ID_ASIGNATURA___ASIGNATURA") ENABLE;
  ALTER TABLE "SYSTEM"."CURSO" ADD FOREIGN KEY ("ID_SALA___CURSO")
	  REFERENCES "SYSTEM"."SALA" ("ID_SALA___SALA") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table INSCRIPCION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INSCRIPCION" ADD FOREIGN KEY ("RUT_ALUMNO___INSCRIPCION")
	  REFERENCES "SYSTEM"."ALUMNO" ("RUT_ALUMNO___ALUMNO") ENABLE;
  ALTER TABLE "SYSTEM"."INSCRIPCION" ADD FOREIGN KEY ("ID_CURSO___INSCRIPCION")
	  REFERENCES "SYSTEM"."CURSO" ("ID_CURSO___CURSO") ENABLE;
--------------------------------------------------------
